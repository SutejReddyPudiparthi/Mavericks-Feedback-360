    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-900 to-brand-600 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Maverick Feedback 360</h1>
          <p className="text-gray-500 text-sm mt-1">Training Feedback & Effectiveness Portal</p>
        </div>
        ...
        {tab === 'password' ? (
          ...
          <form onSubmit={handleOtpLogin} className="space-y-4">
            ...
            {!otpSent ? (
              <button type="button" onClick={handleRequestOtp} className="btn-primary w-full">Send OTP</button>
            ) : (
              <>
                <div>
                ...
                <button type="button" onClick={handleRequestOtp} className="text-sm text-brand-600 hover:underline w-full text-center">Resend OTP</button>
              </>
            )}
          </form>
        )}
        ...
        <div className="mt-6 p-3 bg-gray-50 rounded-lg text-xs text-gray-500 space-y-1">
          ...
          <p>Supervisor: supervisor@maverick360.com / Super@123</p>
          <p>Maverick: maverick1@maverick360.com / Mav@123</p>
        </div>
      </div>
    </div>
  );
