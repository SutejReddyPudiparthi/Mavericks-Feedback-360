...
export default function Reports() {
  ...
  const handleExport = async (format) => {
    try {
      const res = await api.get(
        `/analytics/report?${buildParams()}&format=${format}`,
        { responseType: "blob" },
      );
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Reports"
        subtitle="Generate and export training reports"
      />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFilters((p) => ({ ...p, courseId: e.target.value }))
              }
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFilters((p) => ({ ...p, trainerId: e.target.value }))
              }
            >
