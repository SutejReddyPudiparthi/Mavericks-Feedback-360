...
import {
  MaverickDashboard,
  MaverickFeedbackList,
  MaverickHistory,
  MaverickFeedbackForm,
} from "./pages/maverick/Maverick";
...
import {
  ...
  SupervisorMavericks,
  EvaluationForm,
} from "./pages/supervisor/Supervisor";
  ...
  return (
    <Routes>
      ...
      <Route
        path="/maverick"
        element={
          <ProtectedRoute roles={["Maverick"]}>
            <MaverickDashboard />
          </ProtectedRoute>
        }
      />
      <Route
        path="/maverick/feedback"
        element={
          <ProtectedRoute roles={["Maverick"]}>
            <MaverickFeedbackList />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/supervisor/evaluations/:id"
        element={
          <ProtectedRoute roles={["Supervisor"]}>
            <EvaluationForm />
          </ProtectedRoute>
